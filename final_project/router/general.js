...
public_users.get('/', asyncWrap(getAllHandler));
...
const getByISBNHandler = async (req, res) => {
...
public_users.get('/isbn/:isbn', asyncWrap(getByISBNHandler));
  
// Get book details based on author
const getByAuthorHandler = async (req, res) => {
...
public_users.get('/author/:author', asyncWrap(getByAuthorHandler));

const getByTitleHandler = async (req, res) => {
  //Write your code here
...
public_users.get('/title/:title', asyncWrap(getByTitleHandler));
